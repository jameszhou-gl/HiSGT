...
#     checkpoint = torch.load('../../save/lstm_model',
...
for e in tqdm(range(args.epoch)):
    ...
    for i in range(0, len(train_ehr_dataset), args.batch_size):
        ...
        optimizer.zero_grad()
        loss, _, _ = model(batch_ehr, ehr_labels=batch_ehr,
        ...
        if i % (100*args.batch_size) == 0:
            ...
            with torch.no_grad():
                ...
                for v_i in range(0, len(val_ehr_dataset), args.batch_size):
                    ...
                    val_loss, _, _ = model(
                        batch_ehr, ehr_labels=batch_ehr, ehr_masks=batch_mask, pos_loss_weight=args.pos_loss_weight)
                ...
                if cur_val_loss < global_loss:
                    ...
                    torch.save(state, os.path.join(args.LOG_DIR, f'{args.dataset}_{args.dataset_version}_lstm.pt'))
                    print('\n------------ Save best model ------------\n')
