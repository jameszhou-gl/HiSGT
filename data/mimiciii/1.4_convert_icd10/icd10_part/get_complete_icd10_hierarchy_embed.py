...
with open("data/mimiciii/1.4_convert_icd10/icd10_part/icd10_hierarchical_graph.json") as f:
    graph = json.load(f)
...
for epoch in range(1, 201):
    ...
    np.savez("data/mimiciii/1.4_convert_icd10/icd10_part/complete_icd10_hierarchy_embed.npz",
