...
# Arguments
parser = argparse.ArgumentParser(description="Generate semantic embeddings for ICD-10 codes in vocabulary.")
parser.add_argument("--model_name", type=str, default="emilyalsentzer/Bio_ClinicalBERT", help="Pretrained model name.")
parser.add_argument("--description_type", type=str, default="SHORT-TITLE", choices=['SHORT-TITLE', 'LONG-TITLE'], help="Column to use for descriptions.")
args = parser.parse_args()
    
# Main Execution
if __name__ == "__main__":
    # Load descriptions
    csv_path = "data/mimiciii/1.4_convert_icd10/icd10_part/vocab_stoi_icd10.csv"
    output_path = "data/mimiciii/1.4_convert_icd10/icd10_part/vocab_semantic_embed"
